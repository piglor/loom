...
func (_c *SessionCreate) SetRunID(v string) *SessionCreate {
	_c.mutation.SetRunID(v)
	return _c
}

// SetWorkerID sets the "worker_id" field.
func (_c *SessionCreate) SetWorkerID(v string) *SessionCreate {
	_c.mutation.SetWorkerID(v)
	return _c
}

// SetRuntime sets the "runtime" field.
func (_c *SessionCreate) SetRuntime(v string) *SessionCreate {
	_c.mutation.SetRuntime(v)
	return _c
}

// SetProviderSessionID sets the "provider_session_id" field.
func (_c *SessionCreate) SetProviderSessionID(v string) *SessionCreate {
...
func (_c *SessionCreate) SetNillableProviderSessionID(v *string) *SessionCreate {
	if v != nil {
...
func (_c *SessionCreate) check() error {
	if _, ok := _c.mutation.RunID(); !ok {
		return &ValidationError{Name: "run_id", err: errors.New(`ent: missing required field "Session.run_id"`)}
	}
	if _, ok := _c.mutation.WorkerID(); !ok {
		return &ValidationError{Name: "worker_id", err: errors.New(`ent: missing required field "Session.worker_id"`)}
	}
	if _, ok := _c.mutation.Runtime(); !ok {
		return &ValidationError{Name: "runtime", err: errors.New(`ent: missing required field "Session.runtime"`)}
	}
	return nil
}
...
// SetRunID sets the "run_id" field.
func (u *SessionUpsert) SetRunID(v string) *SessionUpsert {
	u.Set(session.FieldRunID, v)
	return u
}

// UpdateRunID sets the "run_id" field to the value that was provided on create.
func (u *SessionUpsert) UpdateRunID() *SessionUpsert {
	u.SetExcluded(session.FieldRunID)
	return u
}

// SetWorkerID sets the "worker_id" field.
func (u *SessionUpsert) SetWorkerID(v string) *SessionUpsert {
	u.Set(session.FieldWorkerID, v)
	return u
}

// UpdateWorkerID sets the "worker_id" field to the value that was provided on create.
func (u *SessionUpsert) UpdateWorkerID() *SessionUpsert {
	u.SetExcluded(session.FieldWorkerID)
	return u
}

// SetRuntime sets the "runtime" field.
func (u *SessionUpsert) SetRuntime(v string) *SessionUpsert {
	u.Set(session.FieldRuntime, v)
	return u
}

// UpdateRuntime sets the "runtime" field to the value that was provided on create.
func (u *SessionUpsert) UpdateRuntime() *SessionUpsert {
	u.SetExcluded(session.FieldRuntime)
	return u
}

// SetProviderSessionID sets the "provider_session_id" field.
func (u *SessionUpsert) SetProviderSessionID(v string) *SessionUpsert {
	u.Set(session.FieldProviderSessionID, v)
	return u
}

// UpdateProviderSessionID sets the "provider_session_id" field to the value that was provided on create.
func (u *SessionUpsert) UpdateProviderSessionID() *SessionUpsert {
	u.SetExcluded(session.FieldProviderSessionID)
	return u
}

// ClearProviderSessionID clears the value of the "provider_session_id" field.
func (u *SessionUpsert) ClearProviderSessionID() *SessionUpsert {
	u.SetNull(session.FieldProviderSessionID)
	return u
}
...
// SetRunID sets the "run_id" field.
func (u *SessionUpsertOne) SetRunID(v string) *SessionUpsertOne {
...
// UpdateRunID sets the "run_id" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateRunID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateRunID()
	})
}
...
// SetWorkerID sets the "worker_id" field.
func (u *SessionUpsertOne) SetWorkerID(v string) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetWorkerID(v)
	})
}
...
// UpdateWorkerID sets the "worker_id" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateWorkerID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateWorkerID()
	})
}
...
// SetRuntime sets the "runtime" field.
func (u *SessionUpsertOne) SetRuntime(v string) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetRuntime(v)
	})
}
...
// UpdateRuntime sets the "runtime" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateRuntime() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateRuntime()
	})
}
...
// SetProviderSessionID sets the "provider_session_id" field.
func (u *SessionUpsertOne) SetProviderSessionID(v string) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
...
// UpdateProviderSessionID sets the "provider_session_id" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateProviderSessionID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
...
// ClearProviderSessionID clears the value of the "provider_session_id" field.
func (u *SessionUpsertOne) ClearProviderSessionID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
...
// SetRunID sets the "run_id" field.
func (u *SessionUpsertBulk) SetRunID(v string) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetRunID(v)
	})
}
...
// UpdateRunID sets the "run_id" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateRunID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateRunID()
	})
}
...
// SetWorkerID sets the "worker_id" field.
func (u *SessionUpsertBulk) SetWorkerID(v string) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetWorkerID(v)
	})
}
...
// UpdateWorkerID sets the "worker_id" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateWorkerID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateWorkerID()
	})
}
...
// SetRuntime sets the "runtime" field.
func (u *SessionUpsertBulk) SetRuntime(v string) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetRuntime(v)
	})
}
...
// UpdateRuntime sets the "runtime" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateRuntime() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateRuntime()
	})
}
...
// SetProviderSessionID sets the "provider_session_id" field.
func (u *SessionUpsertBulk) SetProviderSessionID(v string) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetProviderSessionID(v)
	})
}
...
// UpdateProviderSessionID sets the "provider_session_id" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateProviderSessionID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateProviderSessionID()
	})
}
...
// ClearProviderSessionID clears the value of the "provider_session_id" field.
func (u *SessionUpsertBulk) ClearProviderSessionID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.ClearProviderSessionID()
	})
}
